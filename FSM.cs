...
namespace AbsoluteZote
{
    ...
    public static class FSM
    {
        ...
        {
            FsmFloat fsmFloat = fsm.FsmVariables.FindFsmFloat(name);
            if (fsmFloat != null)
                return fsmFloat;
            SFCore.Utils.FsmUtil.AddFloatVariable(fsm, name);
            return fsm.FsmVariables.FindFsmFloat(name);
        }
        public static FsmGameObject AccessGameObjectVariable(this PlayMakerFSM fsm, string name)
        {
            FsmGameObject fsmGameObject = fsm.FsmVariables.FindFsmGameObject(name);
            if (fsmGameObject != null)
                return fsmGameObject;
            SFCore.Utils.FsmUtil.AddGameObjectVariable(fsm, name);
            return fsm.FsmVariables.FindFsmGameObject(name);
        }
        public static FsmInt AccessIntVariable(this PlayMakerFSM fsm, string name)
        {
            FsmInt fsmInt = fsm.FsmVariables.FindFsmInt(name);
            if (fsmInt != null)
                return fsmInt;
            SFCore.Utils.FsmUtil.AddIntVariable(fsm, name);
            return fsm.FsmVariables.FindFsmInt(name);
        }
        public static FsmBool AccessBoolVariable(this PlayMakerFSM fsm, string name)
        {
            FsmBool fsmBool = fsm.FsmVariables.FindFsmBool(name);
            if (fsmBool != null)
                return fsmBool;
            SFCore.Utils.FsmUtil.AddBoolVariable(fsm, name);
        ...
        public static System.Action CreateSetVelocity2d(this PlayMakerFSM fsm, float x, float y)
        {
            return () =>
            {
        ...
        public static System.Action CreateFacePosition(this PlayMakerFSM fsm, string destination, bool spriteFaceRight)
        {
            return () =>
            {
        ...
        public static GeneralAction CreateGeneralAction(this PlayMakerFSM fsm, System.Action action)
        {

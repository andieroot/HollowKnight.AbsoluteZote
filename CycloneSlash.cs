...
namespace AbsoluteZote
{
    public partial class Control : Module
    {
        ...
        private void UpdateFSMCycloneSlash(PlayMakerFSM fsm)
        {
            ...
            UnityEngine.Object.Destroy(hits.transform.Find("Hit L").gameObject.GetComponent<PolygonCollider2D>());
            UnityEngine.Object.Destroy(hits.transform.Find("Hit R").gameObject.GetComponent<PolygonCollider2D>());
